...
public class LocationModule {
    ...
    @Provides
    @EarthquakesScope
    LocationInteractor provideInteractor(LocationRepository repository, PermissionsRepository permissionsRepository, SettingsRepository settingsRepository, SchedulersProvider schedulersProvider) {
        return new LocationInteractor(repository, permissionsRepository, settingsRepository, schedulersProvider);
    }

    @Provides
    @EarthquakesScope
    LocationRepository provideRepository(FusedLocationProviderClient locationProviderClient, GoogleApiAvailability googleApiAvailability, Context context) {
